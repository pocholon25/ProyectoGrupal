...
@Composable
fun AbarrotesScreen(navController: NavController,viewModel: AuthViewModel) {

   val productos by viewModel.productos.collectAsState(emptyList())

   LaunchedEffect(Unit) {
      viewModel.productsByCategory("Abarrotes")
   }
   Column(
      modifier = Modifier
         .fillMaxSize()
      ...
      LazyGrid(
         ...
         ItemCard(
            ...
            onAddToCartClick = {
               ...
               Log.d("Carrito", "Producto añadido: ${producto.nombre}")
